...
SECRET_KEY = 'django-insecure-f0)l5j62m7@=(bco18yo6_lmtk7t262--$+9e&bqgoxo0rx8(!'
...
INSTALLED_APPS = [
    'django.contrib.admin', # 管理画面の機能を持つアプリケーション
    'django.contrib.auth', # 認証機能を持つアプリケーション
    ...
    'django.contrib.staticfiles', # 静的ファイル(CSS,js)に関連する機能をもつアプリケーション
